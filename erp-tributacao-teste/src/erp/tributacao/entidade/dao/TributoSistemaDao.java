...
public class TributoSistemaDao extends DaoGenerico<TributoSistema> {
    ...
    public TributoSistemaDao() {
        ...
        selecionadorValoresTributo = new SelecionadorValoresTributo(1L, "prod.ncm.indexOf('33') != 0", valoresTributoDao.find(2L));
        tributoSistemaIcms.getSelecionadorValoresTributos().add(selecionadorValoresTributo);

        // Produtos como perfume, aliquota 25%
        selecionadorValoresTributo = new SelecionadorValoresTributo(2L, "prod.ncm.indexOf('33') == 0", valoresTributoDao.find(3L));
        tributoSistemaIcms.getSelecionadorValoresTributos().add(selecionadorValoresTributo);
